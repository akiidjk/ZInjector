...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "ZInjector" is the name you will use in your source code to
                // import this module (e.g. `@import("ZInjector")`). The name is
    ...
    const dll = b.addLibrary(.{
        ...
        .root_module = b.createModule(.{
            .link_libc = true,
            .root_source_file = b.path("src/evildll.zig"),
            .target = win64_target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "evilddll", .module = mod },
            },
        }),
    });
